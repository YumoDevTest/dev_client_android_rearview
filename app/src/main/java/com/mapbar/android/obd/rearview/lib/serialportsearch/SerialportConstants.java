...
public class SerialportConstants {
    public static final String[] SERIALPORT_PATHS = {"/dev/ttyMT0", "/dev/ttyMT1", "/dev/ttyMT2", "/dev/ttyMT3", "/dev/ttyS1", "/dev/ttyS2", "/dev/ttyS3", "/dev/ttyS4"};
    ...
    public static final int SERIALPORT_FIND_RESCAN = 103;
}
