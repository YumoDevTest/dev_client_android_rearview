package com.mapbar.android.obd.rearview.modules.push.ixintui;
...
import com.mapbar.android.obd.rearview.modules.push.ChangePhonePushDispatcher;
import com.mapbar.android.obd.rearview.lib.config.MyApplication;
import com.mapbar.android.obd.rearview.modules.push.VinPushDispatcher;
import com.mapbar.obd.foundation.log.LogUtil;
import com.mapbar.android.obd.rearview.lib.config.URLconfigs;
    ...
    public void onAppearMsg(Context context, String msg, String extra) {
        if (!TextUtils.isEmpty(msg)) {
            ...
            try {
                ...
                ChangePhonePushDispatcher.onReceivePushMessage(type, state, userId, token);
                //修改 VIN 相关的推送
