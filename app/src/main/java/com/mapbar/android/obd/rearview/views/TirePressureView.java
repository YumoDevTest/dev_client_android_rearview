 ...
 */
public class TirePressureView extends FrameLayout {
    ...
    public TirePressureView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        View content = layoutInflater.inflate(R.layout.tire_pressure_view, null);
