...
//        bean.is_support_windows =  parseBoolean(data.lightsdetail, 31);//是否支持 车窗
        ...
        bean.is_on_light_fog_back = parseBoolean(data.lightsdetail, 4);//前雾灯
        ...
        bean.is_support_left_front_lock = false;//是否支持 左前门锁状态
        bean.is_on_left_front_lock = false;//是否锁 左前门锁
        bean.is_support_right_front_lock = false;//是否支持 右前门锁状态
        bean.is_on_righ_front_lock = false;//是否锁 右前门锁
        bean.is_support_left_back_lock = false;//是否支持 左后门锁状态
        bean.is_on_left_back_lock = false;//是否锁 左后门锁
        bean.is_support_right_back_lock = false;//是否支持 右后门锁状态
        bean.is_on_right_back_lock = false;//是否锁 右后门锁

        bean.is_support_left_front_door = false;//是否支持 左前门开关状态
        bean.is_on_left_front_door = false;//是否打开 左前门
        bean.is_support_right_front_door = false;//是否支持 右前开关状态
        bean.is_on_righ_front_door = false;//是否打开 右前门
        bean.is_support_left_back_door = false;//是否支持 左后门开关状态
        bean.is_on_left_back_door = false;//是否打开 左后门
        bean.is_support_right_back_door = false;//是否支持 右后门开关状态
        bean.is_on_right_back_door = false;//是否打开 右后门

        bean.is_support_left_front_window = false;//是否支持 左前门车窗状态
        bean.is_on_left_front_window = false;//是否打开 左前门车窗
        bean.is_support_right_front_window = false;//是否支持 右前车窗状态
        bean.is_on_righ_front_window = false;//是否打开 右前门车窗
        bean.is_support_left_back_window = false;//是否支持 左后门车窗状态
        bean.is_on_left_back_window = false;//是否打开 左后门车窗
        bean.is_support_right_back_window = false;//是否支持 右后门车窗状态
        bean.is_on_right_back_window = false;//是否打开 右后门车窗
        return bean;
    }

    public static boolean parseBoolean(int value, int index) {
        boolean b = ((value >> index) & 0x01) == 0x01;
        return b;
    }
