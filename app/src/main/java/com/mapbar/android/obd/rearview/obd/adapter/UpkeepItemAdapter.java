...
public class UpkeepItemAdapter<VH extends RecyclerView.ViewHolder> extends RecyclerView.Adapter {
    ...
    private String[] names = {"更换发动机机油", "发动机润滑油", "更换机油滤清器", "更换空气滤清器", "更换PCV滤清器", "更换燃油滤清器",
            "更换燃油粗滤器", "更换燃油空气滤清器", "更换火花塞", "更换前桥齿轮油", "更换后桥齿轮油", "更换齿轮油", "更换制动液", "更换主减速器油",
            "更换发动机皮带", "更换压缩机皮带", "更换转向助力皮带", "更换传动皮带套件", "更换发动机正时套件", "更换空调滤清器", "前制动器", "后制动器",
            ...
            "更换冷却液", "更换转向助力液", "更换变速器油", "变速箱油（CVT）", "变速箱油（AT）", "变速箱油（MT）", "变速箱油（DCT）", "变速箱油（AMT）"};
