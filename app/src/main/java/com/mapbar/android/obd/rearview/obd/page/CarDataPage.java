...
//        switch (value1) {
//            case 0:
//                MobclickAgentEx.onEvent(getContext(), UmengConfigs.GASCONSUM);
//                break;
//            case 1:
//                MobclickAgentEx.onEvent(getContext(),UmengConfigs.TRIPTIME);
//                break;
//            case 2:
//                MobclickAgentEx.onEvent(getContext(),UmengConfigs.TRIPLENGTH);
//                break;
//            case 3:
//                MobclickAgentEx.onEvent(getContext(),UmengConfigs.DRIVECOST);
//                break;
//            case 4:
//                MobclickAgentEx.onEvent(getContext(),UmengConfigs.SPEED);
//                break;
//            case 5:
//                MobclickAgentEx.onEvent(getContext(),UmengConfigs.RPM);
//                break;
//            case 6:
//                MobclickAgentEx.onEvent(getContext(),UmengConfigs.VOLTAGE);
//                break;
//            case 7:
//                MobclickAgentEx.onEvent(getContext(),UmengConfigs.ENGINECOOLANTTEMPERATURE);
//                break;
//            case 8:
//                MobclickAgentEx.onEvent(getContext(),UmengConfigs.AVERAGEGASCONSUM);
//                break;
//        }
//    }
//
